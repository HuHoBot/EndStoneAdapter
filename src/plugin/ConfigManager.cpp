...
ConfigManager::ConfigManager() { Load("plugins/HuHoBot/config.json"); }
...
// Getter实现
int ConfigManager::GetVersion() const { return data_["version"]; }

std::string ConfigManager::GetServerId() const { return data_["serverId"]; }

std::string ConfigManager::GetHashKey() const { return data_["hashKey"]; }

std::string ConfigManager::GetChatFormatFromGame() const { return data_["chatFormat"]["from_game"]; }

std::string ConfigManager::GetChatFormatFromGroup() const { return data_["chatFormat"]["from_group"]; }

bool ConfigManager::GetPostChat() const { return data_["chatFormat"]["post_chat"]; }

std::string ConfigManager::GetPostPrefix() const { return data_["chatFormat"]["post_prefix"]; }

std::string ConfigManager::GetMotdUrl() const { return data_["motdUrl"]; }

std::string ConfigManager::GetServerName() const { return data_["serverName"]; }

std::vector<CustomCommand> ConfigManager::GetCustomCommands() const { return data_["customCommand"]; }

// Setter实现
void ConfigManager::SetServerId(const std::string& id) { data_["serverId"] = id; }

void ConfigManager::SetHashKey(const std::string& key) { data_["hashKey"] = key; }
